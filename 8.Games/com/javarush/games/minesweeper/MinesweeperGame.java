...
public class MinesweeperGame extends Game {
    ...
    private void countMineNeighbors(){
        List<GameObject> neighborsMine;
        for (int y = 0; y < SIDE; y++) {
            for (int x = 0; x < SIDE; x++) {
                if (!gameField[y][x].isMine){
                    neighborsMine = getNeighbors(gameField[y][x]);
                    for (int i = 0; i < neighborsMine.size(); i++){
                        if(neighborsMine.get(i).isMine){
    ...
    private void win() {
        isGameStopped = true;
        showMessageDialog(Color.WHITE, "You win! Congratulations!", Color.RED, 40);
    }
    ...
    private void gameOver() {
        isGameStopped = true;
        showMessageDialog(Color.WHITE, "Game over! You Lose!", Color.RED, 40);
    }
